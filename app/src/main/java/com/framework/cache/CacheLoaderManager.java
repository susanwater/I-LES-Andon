...
import com.framework.cache.disk.naming.FileNameGenerator;
import com.framework.cache.disk.read.BitmapReadFromDisk;
import com.framework.cache.disk.read.BytesReadFromDisk;
import com.framework.cache.disk.read.InputStreamReadFormDisk;
import com.framework.cache.disk.read.SerializableReadFromDisk;
import com.framework.cache.disk.read.StringReadFromDisk;
import com.framework.cache.disk.write.BitmapWriteInDisk;
import com.framework.cache.disk.write.BytesWriteInDisk;
import com.framework.cache.disk.write.SerializableWriteInDisk;
import com.framework.cache.disk.write.StringWriteInDisk;
import com.framework.cache.entity.CacheGetEntity;
import com.framework.cache.entity.CachePutEntity;
import com.framework.cache.memory.MemoryCache;
import com.framework.cache.util.MemoryCacheUtils;
...
public class CacheLoaderManager {
	...
	public void init(Context context, FileNameGenerator diskCacheFileNameGenerator, long diskCacheSize,
		...
		//MemoryCache memoryCache1 = (MemoryCache) MemoryCacheUtils.createLruMemoryCache(maxMemorySize);
	...
	public String loadString(String key){
		...
		String cacheData=cacheTask.query(key, cacheGetEntity);
		if(cacheData!=null&&cacheData.contains("UTF-8")){
			return cacheData.replaceFirst("UTF-8","");
		}
		return cacheData;
	}
