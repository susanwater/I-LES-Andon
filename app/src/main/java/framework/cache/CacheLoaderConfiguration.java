...
import framework.cache.disk.impl.LimitedAgeDiskCache;
import framework.cache.disk.naming.FileNameGenerator;
import framework.cache.memory.MemoryCache;
import framework.cache.memory.impl.LimitedAgeMemoryCache;
import framework.cache.util.DiskCacheUtils;
