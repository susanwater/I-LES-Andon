 ...
 *******************************************************************************/
package framework.cache.disk.impl.ext;
...
import framework.cache.disk.read.ReadFromDisk;
import framework.cache.disk.write.WriteInDisk;


/**
 * Disk cache based on "Least-Recently Used" principle. Adapter pattern, adapts
 * {@link com.nostra13.universalkeyloader.cache.disc.impLazyLogger.ext.DiskLruCache
 * DiskLruCache} to {@link com.nostra13.universalkeyloader.cache.disc.DiskCache
 * DiskCache}
 *
...
public class LruDiskCache implements DiskCache {
	 ...
	 *            {@linkplain com.nostra13.universalkeyloader.cache.disc.naming.FileNameGenerator
