...
import framework.cache.memory.SizeOfCacheCalculator;
import framework.cache.memory.impl.EntryRemovedProcessMemoryCache;
import framework.cache.memory.impl.LruMemoryCache;
import framework.cache.memory.impl.SizeOfMemoryCache;
